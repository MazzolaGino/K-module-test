...
class TwitterTest extends TestCase
{
    ...
    {
        $this->assertIsObject($this->twitterClient->userSearch()
    ...
    {
        $this->assertIsObject($this->twitterClient->timeline()
    ...
    public function testTweet(): void
    {
        ...
        $return = $this->twitterClient->tweet()->performRequest('POST', [
            'text' => 'BIP BIP BIP... ' . $date->format(\DateTimeInterface::ATOM) . ' Wake up!  A new commit is on github (noweh/twitter-api-v2-php)....'
        ]);
    ...
    {
        $this->assertIsObject($this->twitterClient->tweet()
            ->performRequest('GET', [

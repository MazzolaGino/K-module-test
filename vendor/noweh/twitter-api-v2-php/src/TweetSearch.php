...
class TweetSearch extends AbstractController
{
    ...
    protected function constructEndpoint(): string
    {
        ...
        if (! empty($this->filteredUsernamesFrom)) {
            $endpoint .= '%20(from:' . implode('%20' . $this->operatorOnFilteredUsernamesFrom->value . '%20from:', $this->filteredUsernamesFrom) . ')';
        }

        if (! empty($this->filteredUsernamesTo)) {
            $endpoint .= '%20(to:' . implode('%20' . $this->operatorOnFilteredUsernamesTo->value . '%20to:', $this->filteredUsernamesTo) . ')';
        }

...
class HandlerStack
{
     ...
     *
     * @param
     *            (callable(RequestInterface, array): PromiseInterface)|null $handler HTTP handler function to use with the stack. If no
     ...
     *
     * @param
     *            (callable(RequestInterface, array): PromiseInterface)|null $handler Underlying HTTP handler.
     */
     ...
     *
     * @param
     *            callable(RequestInterface, array): PromiseInterface $handler Accepts a request and array of options and
     *            returns a Promise.
     */

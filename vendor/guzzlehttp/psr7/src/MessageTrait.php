...
trait MessageTrait
{
     ...
     *
     * @param
     *            array<string|int, string|string[]> $headers
     */
    ...
    {
        if (! is_array($value)) {
            return $this->trimAndValidateHeaderValues([
                $value
            ]);
        }
    ...
    /**
     *
     * @see https://tools.ietf.org/html/rfc7230#section-3.2 field-value = *( field-content / obs-fold )
